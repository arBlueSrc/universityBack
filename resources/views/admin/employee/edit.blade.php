            ...
            <div class="card-body" id="card">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="نام را وارد کنید" value="{{ Crypt::decrypt($employee->name) }}">
                    </div>

                    <div class="form-group col-6">
                        <label for="last_name">نام خانوادگی</label>
                        <input type="text" name="last_name" class="form-control" id="last_name" value="{{ Crypt::decrypt($employee->last_name) }}"
                ...
                <div class="row col-6" style="margin-top: 10px">
                    ...
                    <select name="part" id="part" class="form-control">
                        @foreach ($parts as $part)
                            <option value="{{ $part->id }}" @if($part->id == $employee->part_id) selected @endif>
